...
mod tests {
    ...
    fn union() {
        ...
        vec![
            ...
            // },
            Test {
                name: "solid subject overlaping solid clip",
            ...
            Test {
                name: "enclosing-subject hole overlaping solid clip",
                subject: Shape {
                    boundaries: vec![
            ...
            Test {
                name: "solid subject overlaping enclosing-clip hole",
            ...
            //     subject: Shape::new(vec![[0., 0.], [1., 0.], [1., 1.], [0., 1.]]),
            //     clip: Shape::new(vec![[1., 1.], [1., 2.], [2., 2.], [2., 1.]]),
            //     want: Some(Shape {
            //         boundaries: vec![
            //             // Counter-clockwise boundary.
            //             vec![[0., 0.], [1., 0.], [1., 1.], [0., 1.]].into(),
